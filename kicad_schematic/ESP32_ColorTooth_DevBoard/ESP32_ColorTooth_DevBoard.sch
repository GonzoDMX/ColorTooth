...
encoding utf-8
Sheet 1 1
Title "ColorTooth Dev Board"
Date "29/01/2021"
Rev "1.0"
Comp "Andrew O'Shei"
Comment1 "Projet L3 MIME"
Comment2 ""
Comment3 ""
Comment4 ""
$EndDescr
$Comp
L esp32_doit_dev_board:ESP32_DOIT_Dev_Board U?
U 1 1 60554373
P 7100 3000
F 0 "U?" H 7075 4115 50  0000 C CNN
F 1 "ESP32_DOIT_Dev_Board" H 7075 4024 50  0000 C CNN
F 2 "ESP32_DOIT:ESP_DOIT_Dev_Board" H 7100 3000 50  0001 C CNN
F 3 "" H 7100 3000 50  0001 C CNN
	1    7100 3000
	1    0    0    -1  
$EndComp
$Comp
L ColorClick:ColorClick U?
U 1 1 60556DB2
P 3800 3050
F 0 "U?" H 3800 3865 50  0000 C CNN
F 1 "ColorClick" H 3800 3774 50  0000 C CNN
...
U 1 1 605573D5
P 4600 5450
F 0 "U?" V 4554 6494 50  0000 L CNN
F 1 "MAX7219" V 4645 6494 50  0000 L CNN
F 2 "" H 4550 5500 50  0001 C CNN
F 3 "https://datasheets.maximintegrated.com/en/ds/MAX7219-MAX7221.pdf" H 4650 5300 50  0001 C CNN
	1    4600 5450
	0    1    1    0   
$EndComp
$Comp
...
U 1 1 60558DE2
P 7500 5900
F 0 "SW?" H 7500 6135 50  0000 C CNN
F 1 "SW_SPST" H 7500 6044 50  0000 C CNN
...
U 1 1 6055A3C0
P 7700 5250
F 0 "R?" H 7770 5296 50  0000 L CNN
F 1 "5K6" H 7770 5205 50  0000 L CNN
...
U 1 1 605669F3
P 8500 5900
F 0 "SW?" H 8500 6135 50  0000 C CNN
F 1 "SW_SPST" H 8500 6044 50  0000 C CNN
...
F 1 "5K6" H 8770 5205 50  0000 L CNN
...
U 1 1 60566FD5
P 9450 5900
F 0 "SW?" H 9450 6135 50  0000 C CNN
F 1 "SW_SPST" H 9450 6044 50  0000 C CNN
...
F 1 "5K6" H 9720 5205 50  0000 L CNN
...
U 1 1 60567922
P 10300 5900
F 0 "SW?" H 10300 6135 50  0000 C CNN
F 1 "SW_SPST" H 10300 6044 50  0000 C CNN
...
F 1 "5K6" H 10570 5205 50  0000 L CNN
...
ALL Button
Wire Wire Line
	7850 3450 10900 3450
Wire Wire Line
	10900 3450 10900 5550
Wire Wire Line
...
Wire Wire Line
	2850 2550 3100 2550
Text Notes 6600 3000 0    197  ~ 0
ESP32
Text Notes 3400 3100 0    118  ~ 0
TCS3471
$Comp
L power:GND #PWR?
U 1 1 605B0580
...
Wire Wire Line
	5550 3150 5550 4750
NoConn ~ 4000 5050
Text GLabel 4200 6400 0    197  Input ~ 0
7-SegDisplay
Wire Wire Line
	4200 6400 4600 6400
Wire Wire Line
